...
$(document).ready(()=>{
	...
	function pwConfirm(){
	   ...
	   if(userPw.search(/\s/)!=-1){
	      ...
	      result.innerHTML = "비밀번호는 공백 없이 입력해주세요!";
	   } else if (userPw.length < 8 || userPw.length > 20){
	      pwd=false;
	      result.style.color = "#ff0000";
	      result.innerHTML = "8자리 ~ 20자리 이내로 입력해주세요!";
	   } else if( num < 0 || eng < 0 || spe < 0 ){
	      pwd=false;
	      result.style.color = "#ff0000";
	      result.innerHTML = "영문, 숫자, 특수문자를 혼합하여 입력해주세요!";
	   } else {
	      pwd=true;
	      result.style.color = "#0000ff";
	      result.innerHTML = "적절한 비밀번호 입니다!";
	   }
	}
