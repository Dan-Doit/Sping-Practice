...
public class BoardControllerTest {
	...
	public void boardWriteTest() throws Exception {
		...
		FileInputStream inputFile = new FileInputStream( "C:\\Users\\zmffh\\SemiColne\\images\\friend.jpg");  
		MockMultipartFile file = new MockMultipartFile("file", "friend.jpg", "multipart/form-data", inputFile);
