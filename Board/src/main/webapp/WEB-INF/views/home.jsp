			...
			<c:if test="${!empty msg}"><script>alert('${msg}')</script></c:if>
			  ...
			  <div id="second">
					<div class="myform form ">
						...
						<form action="signup" name="registration" id="regForm" method="post">
							<div class="form-group">
								<label>Identity code</label> 
								<input type="text" name="mid" class="form-control" id="joinid" onchange="idOverlap()" placeholder="Enter Id">
									<span id="checkresult"></span>
							</div>
							<div class="form-group">
								<label>Password</label> <input type="password" name="mpwd"
									id="joinpwd" class="form-control" onchange="pwConfirm()" placeholder="Enter Password">
...
/* function init() {
  ...
  //아이디 중복 체크
	...
	//비밀번호 정규식
	function pwConfirm(){
		var userPw = document.getElementById("joinpwd").value;
	...
	$(function() {
         $("form[name='login']").validate({
             rules: {		               
		      ...
		      messages: {
		          mid: "Please enter a valid email address",
