    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default panel-table">
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Write your thought!</h3>
                  </div>
              ...
              <div class="col col-xs-6 text-right">
                     ...
                     <ul class="pagination hidden-xs pull-right">
                      ...
                      <input type="submit" class="btn btn-sm btn-primary btn-create" value="Create New">
                    </ul>
                  </div>
            ...
            <tr>
				<th>작성자</th>
				<td>${mname}</td>
				<input type="hidden" name="bwriter" value="${mname}">
			</tr>
			<tr>
			...
			<tr>
			<th>내용</th>
				<td><textarea rows="10" cols="100%" name="bcontents"></textarea></td>
			</tr>
